...
public class PopupWindowUtils {
    ...
    public static PopupWindow getPopupWindowInCenter(View contentView, int width, int height,
        ...
        return getPopupWindowAtLocation(contentView, width, height, parentView, Gravity.CENTER, 0,
                0);
    }
     ...
     */
    public static PopupWindow getPopupWindowAsDropDownParentAuto(View contentView, int width,
                                                                 int height, View anchorView, Activity activity) {
     ...
     * @param yoff        y轴偏移量
     */
    public static PopupWindow getPopupWindowAsDropDown(View contentView, int width, int height,
    ...
    public static PopupWindow getPopupWindowAsDropDown(View contentView, int width, int height,
                                                       View anchorView, int gravityType, int xoff, int yoff) {
        PopupWindow popupWindow = getPopupWindow(contentView, width, height);
